...
<?php
    ...
    if(isset($_GET['search']) && !empty($_GET['search'])){
      $key =$_GET['search'];
      $products=mysqli_query($conn,"SELECT *FROM `hang` WHERE `TenHang` LIKE '%$key%' ORDER BY TenHang");
    }
    else{
      $products=mysqli_query($conn,"SELECT *FROM `hang`");
    }
?>
	<!-- Header -->
	<header>
		...
		<div class="menu-mobile">
			<ul class="topbar-mobile">
				...
				<div class="right-top-bar flex-w h-full">
                            ...
                            ?>
                                    <a href="./login.php" class="flex-c-m trans-04 p-lr-25"><i class="fa fa-user p-2"></i>Login</a>
                            <?php 
                                }
                            ?>
                            <a href="./logout.php" class="flex-c-m trans-04 p-lr-25"><i class="fa fa-sign-out" aria-hidden="true"></i>Logout</a>
				...
				<!-- Search product -->
		  		<div class="dis-none panel-search w-full p-t-10 p-b-15">
					<div class="bor8 dis-flex p-l-15">
						...
						<input name="search" class="mtext-107 cl2 size-114 plh2 p-r-15" type="text" placeholder="Search" value="<?php if(isset($_GET['search'])){ echo $_GET['search'];}?>">
					</div>	
				</div>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="images/<?=$row['Anh']?>" alt="IMG-PRODUCT">

							<a href="product-detail.php?MaHang=<?=$row['MaHang'];?>" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04">
								Buy
							</a>
						</div>
